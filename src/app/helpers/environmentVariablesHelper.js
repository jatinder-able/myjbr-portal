...
let envVariables = {
  LEARNER_URL: env.sunbird_learner_player_url || 'https://pwcdemoinstance.ddns.net/api/',
  CONTENT_URL: env.sunbird_content_player_url || 'https://pwcdemoinstance.ddns.net/api/',
  CONFIG_URL: env.sunbird_config_service_url || 'https://pwcdemoinstance.ddns.net/api/config/',
  CONFIG_REFRESH_INTERVAL: env.config_refresh_interval || 10,
  CONFIG_SERVICE_ENABLED: env.config_service_enabled || false,
  CONTENT_PROXY_URL: env.sunbird_content_proxy_url || 'https://pwcdemoinstance.ddns.net',
  ...
  PORTAL_ECHO_API_URL: env.sunbird_echo_api_url || 'https://pwcdemoinstance.ddns.net/api/echo/',
  ...
  DATASERVICE_URL: env.sunbird_dataservice_url || 'https://pwcdemoinstance.ddns.net/api/',
