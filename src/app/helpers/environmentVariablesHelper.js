...
let envVariables = {
  LEARNER_URL: env.sunbird_learner_player_url || 'https://testpwc.ddns.net/api/',
  CONTENT_URL: env.sunbird_content_player_url || 'https://testpwc.ddns.net/api/',
  CONFIG_URL: env.sunbird_config_service_url || 'https://testpwc.ddns.net/api/config/',
  CONFIG_REFRESH_INTERVAL: env.config_refresh_interval || 10,
  CONFIG_SERVICE_ENABLED: env.config_service_enabled || false,
  CONTENT_PROXY_URL: env.sunbird_content_proxy_url || 'https://testpwc.ddns.net',
  PORTAL_REALM: env.sunbird_portal_realm || 'sunbird',
  PORTAL_AUTH_SERVER_URL: env.sunbird_portal_auth_server_url || 'https://testpwc.ddns.net/auth',
  ...
  PORTAL_API_AUTH_TOKEN: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiIxOTA3MDY0MGY5MTI0YzMyOWZjY2I2MWYwNTQ2M2RkYyJ9.4_wwo6J5QgwdQaOPSlqh0iHOAFwWNlVWY_syit3DDGQ",
  PORTAL_TELEMETRY_PACKET_SIZE: env.sunbird_telemetry_packet_size || 1000,
  PORTAL_ECHO_API_URL: env.sunbird_echo_api_url || 'https://testpwc.ddns.net/api/echo/',
  ...
  DATASERVICE_URL: env.sunbird_dataservice_url || 'https://testpwc.ddns.net/api/',
